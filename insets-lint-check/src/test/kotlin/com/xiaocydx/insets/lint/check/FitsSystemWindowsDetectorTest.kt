...
internal class FitsSystemWindowsDetectorTest {
    ...
    fun sourceCodeTrueLiteralWarning() {
        lint()
            ...
            .expect(
                """
                src/test/pkg/TestClass.java:7: Error:  fitsSystemWindows = true 会导致其他View不能处理WindowInsets [FitsSystemWindows]
                        view.setFitsSystemWindows(true);
                        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                src/test/pkg/TestClass.kt:7: Error:  fitsSystemWindows = true 会导致其他View不能处理WindowInsets [FitsSystemWindows]
